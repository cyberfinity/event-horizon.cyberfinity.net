...
$page = new Page('XHTML+RDFa page (served as XML)', SDTSiteNav::getSiteNav(), true );
...
?>
			...
			<div resource="http://meatspace.cyberfinity.net/uri/cyberfinity" typeof="schema:Organization">
				...
				<p property="schema:description"><a property="schema:url" href="http://www.cyberfinity.net/">Cyberfinity</a> is a collection of websites produced and maintained by <span property="schema:member" resource="http://meatspace.twiddles.com/uri/james_nash" typeof="schema:Person"><a property="schema:url" href="https://cirrus.twiddles.com/"><span property="schema:name">James Nash</span></a></span> and his friends.</p>
			</div>
